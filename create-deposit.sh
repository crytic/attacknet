...
export VALIDATOR_START=200000
export VALIDATOR_END=220000
...
export KUBE_EXECUTION_SERVICE=geth
...
kubectl --namespace default port-forward svc/$KUBE_EXECUTION_SERVICE $EXEC_POD_PORT &
port_forward_pid=$!
sleep 1
